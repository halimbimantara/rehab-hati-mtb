...
object Utils {
    ...
    fun determineScreenDensityCode(context: Context): String {
        return when (context.resources.displayMetrics.densityDpi) {
            ...
            DisplayMetrics.DENSITY_400, DisplayMetrics.DENSITY_420 -> "xxhdpi"
            DisplayMetrics.DENSITY_XXXHIGH, DisplayMetrics.DENSITY_560 -> "xxxhdpi"
            else -> "Unknown code ${context.resources.displayMetrics.densityDpi}"
        }
    }

//    fun dpToPxGLobal(context: Context, dp: Int): Int {
//        val windowManager = context.getSystemService(Context.WINDOW_SERVICE) as WindowManager
//        val dm = DisplayMetrics()
//        windowManager.defaultDisplay.getMetrics(dm)
//        return (dp * dm.density) as Int
//    }
